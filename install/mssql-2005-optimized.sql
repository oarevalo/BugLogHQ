...
-- Add Primary Key PK_bl_Extension to bl_Extension
Print 'Add Primary Key PK_bl_Extension to bl_Extension'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[bl_Extension]') AND [type]='U')) AND NOT (EXISTS (SELECT * FROM sys.indexes WHERE [name]=N'PK_bl_Extension' AND [object_id]=OBJECT_ID(N'[dbo].[bl_Extension]')))
ALTER TABLE [dbo].[bl_Extension]
	ADD
	CONSTRAINT [PK_bl_Extension]
	PRIMARY KEY
	([ExtensionID])
	ON [PRIMARY]
GO
...
-- Add Primary Key PK_bl_ExtensionLog to bl_ExtensionLog
Print 'Add Primary Key PK_bl_ExtensionLog to bl_ExtensionLog'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[bl_ExtensionLog]') AND [type]='U')) AND NOT (EXISTS (SELECT * FROM sys.indexes WHERE [name]=N'PK_bl_ExtensionLog' AND [object_id]=OBJECT_ID(N'[dbo].[bl_Application]')))
ALTER TABLE [dbo].[bl_ExtensionLog]
	ADD
	CONSTRAINT [PK_bl_ExtensionLog]
	PRIMARY KEY
	([ExtensionLogID])
	ON [PRIMARY]
GO
...
-- Add Primary Key PK_bl_userApplication to bl_userApplication
Print 'Add Primary Key PK_bl_userApplication to bl_userApplication'
GO
IF (EXISTS(SELECT * FROM sys.objects WHERE [object_id] = OBJECT_ID(N'[dbo].[bl_userApplication]') AND [type]='U')) AND NOT (EXISTS (SELECT * FROM sys.indexes WHERE [name]=N'PK_bl_userApplication' AND [object_id]=OBJECT_ID(N'[dbo].[bl_userApplication]')))
ALTER TABLE [dbo].[bl_userApplication]
	ADD
	CONSTRAINT [PK_bl_userApplication]
	PRIMARY KEY
	([userApplicationID])
	ON [PRIMARY]
GO
