...
<cfif structKeyExists(request.requestState,"aQueue")>
	<cfset aQueue = request.requestState.aQueue>
	<cfset hasQueue = true>
<cfelse>
	<cfset hasQueue = false>
</cfif>
		...
		<tr valign="top">
			...
			<td>
				<table class="browseTable" style="width:100%">
					...
					<cfelse>
						<tr><td colspan="5"><em>Message queuing is not supported in the current listener.</em></td></tr>
					</cfif>
				</table>
			</td>
		</tr>
